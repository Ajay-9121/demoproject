...
<AnalyticsProvider
      ...
      <div className="banner-section">
            <div className='banner-text banner-dark-bg justify-center text-center' style={{backgroundImage:"url(https://a.mktgcdn.com/p-sandbox/X2RGNvx2ILDdu4Btsbx2xa-UWYchDuBUEn7svQbJd28/717x532.jpg)",backgroundSize: "cover",backgroundRepeat:"no-repeat",backgroundPosition:"center"}}>
              {/* <img className="banner-img" src={c_bannerSection.bannerimage.url} alt="" width={100}height={100} /> */}
              <h1 className="banner-content">{name}</h1>
  ...
  {/* <About /> */}
    ...
    <div className="about-section">
      <div className="about-item">
        ...
        {c_aboutUs.aboutimg?<img src={c_aboutUs.aboutimg.url} width="90%" height={350} alt="" />:"please upload image"}
        </div>

        <div className="about-content">
          <div className="about-heading"><h2>{c_aboutUs.aboutheading}- {name}</h2></div>
          <div className="about-description"><p>{c_aboutUs.description}</p></div>
          <button className="about-btn"><a href={c_aboutUs.showMore.link}>{c_aboutUs.showMore.label}</a></button>
        </div>
        ...
        <div className="nearby-sec">
          ...
          <FeaturesBrand c_slider={c_slider} />
