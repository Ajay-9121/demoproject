  ...
  return (
    <>
      ...
      <div className="banner-section">
            <div className='banner-text banner-dark-bg justify-center text-center' style={{backgroundImage:"url(https://dynl.mktgcdn.com/p/zqwuK0BCGsQUBPLW42hg5ieoSFZMOh3iVOSHIM2q22k/1330x204)",backgroundSize: "cover",backgroundRepeat:"no-repeat",backgroundPosition:"center"}}>
              {/* <img className="banner-img" src={c_bannerSection.bannerimage.url} alt="" width={100}height={100} /> */}
              <h1 className="banner-content">MGM TIMBER</h1>
